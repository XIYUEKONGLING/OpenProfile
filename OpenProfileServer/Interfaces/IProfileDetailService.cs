...
{
    // Work Experience
    Task<ApiResponse<IEnumerable<WorkExperienceDto>>> GetWorkAsync(Guid profileId);
    ...
    // Education
    Task<ApiResponse<IEnumerable<EducationExperienceDto>>> GetEducationAsync(Guid profileId);
    ...
    // Projects
    Task<ApiResponse<IEnumerable<ProjectDto>>> GetProjectsAsync(Guid profileId);
